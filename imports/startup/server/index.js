...
import { registerJobsRuntimeHooks, startJobsWorker } from "../../api/jobs/index.js";
...
console.log("[channels] registry.validated", { count: channelConnectorHashes.length, files: channelConnectorHashes });
...
if (isWorkerRuntime()) {
  ...
  console.log("[runtime] web mode active; background workers are disabled in this process");
}
