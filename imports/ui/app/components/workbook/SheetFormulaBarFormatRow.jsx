...
import { getFontFamilyLabel, getFormatLabel } from './WorkbookChrome.jsx';
  ...
  return (
    <div className="formula-bar-row formula-bar-row-format">
      <div className="formula-cluster formula-cluster-format">
        <button id="undo-action" type="button" aria-label="Undo" title="Undo">
          <LucideIcon size={18}>
            <path d="m9 14-5-5 5-5" />
            <path d="M4 9h11a4 4 0 1 1 0 8h-1" />
          </LucideIcon>
        </button>
        <button id="redo-action" type="button" aria-label="Redo" title="Redo">
          <LucideIcon size={18}>
      ...
      <div className="formula-cluster formula-cluster-format">
        ...
        <button
          ...
          disabled={!!formulaBarUi.decimalsDisabled}
        >
          <LucideIcon size={16}>
            <path d="M4.5 8h8" />
            <path d="M4.5 16h5" />
      ...
      <div className="formula-cluster formula-cluster-format">
        <div className="formula-icon-select">
          <div id="cell-align" className="cell-align-group" role="group" aria-label="Cell align">
            <button
              type="button"
              className={`cell-align-button${formulaBarUi.align === 'left' ? ' is-active' : ''}`}
              data-align="left"
            ...
            <button
              type="button"
              className={`cell-align-button${formulaBarUi.align === 'center' ? ' is-active' : ''}`}
              data-align="center"
            ...
            <button
              type="button"
              className={`cell-align-button${formulaBarUi.align === 'right' ? ' is-active' : ''}`}
              data-align="right"
        ...
        <div className="formula-icon-select">
          <div className="cell-borders-picker">
            <button
              id="cell-borders"
              type="button"
              onClick={handleToggleCellBorders}
              ...
              {[
                ...
                <button
                  ...
                  className={`cell-borders-option${
                    String(formulaBarUi.bordersPreset || 'none') === preset ? ' is-active' : ''
                  }`}
                  data-preset={preset}
      ...
      <div className="formula-cluster formula-cluster-format">
          ...
          <div className="cell-bg-color-picker">
            ...
            >
              <span
                ...
                aria-hidden="true"
                style={{ backgroundColor: formulaBarUi.backgroundColor || 'transparent' }}
              ></span>
            </button>
            <div
            ...
            >
              <div className="cell-bg-color-section">
                ...
                <div className="cell-bg-color-grid">
                  <button
                    type="button"
                    className={`cell-bg-color-chip is-none${!formulaBarUi.backgroundColor ? ' is-active' : ''}`}
                    data-color=""
                    title="No fill"
                  >
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`cell-bg-color-chip${
                        formulaBarUi.backgroundColor === color ? ' is-active' : ''
                      }`}
                      data-color={color}
                      title={title}
              ...
              <label className="cell-bg-color-custom" htmlFor="cell-bg-color-custom">
        ...
        <div className="formula-icon-select">
          <button
            ...
            disabled={!!formulaBarUi.fontSizeDisabled}
          >
            <LucideIcon size={16}>
              <path d="M6 12h12" />
            </LucideIcon>
            ...
            >
              <button
                ...
                className={`cell-font-family-option${
                  String(formulaBarUi.fontFamily || 'default') === 'default' ? ' is-active' : ''
                }`}
              ...
              <button
                type="button"
                className={`cell-font-family-option${
                  String(formulaBarUi.fontFamily || 'default') === 'sans' ? ' is-active' : ''
                }`}
              ...
              <button
                type="button"
                className={`cell-font-family-option${
                  String(formulaBarUi.fontFamily || 'default') === 'serif' ? ' is-active' : ''
                }`}
              ...
              <button
                type="button"
                className={`cell-font-family-option${
                  String(formulaBarUi.fontFamily || 'default') === 'mono' ? ' is-active' : ''
                }`}
              ...
              <button
                type="button"
                className={`cell-font-family-option${
                  String(formulaBarUi.fontFamily || 'default') === 'display' ? ' is-active' : ''
                }`}
      ...
      <div className="formula-cluster formula-cluster-format">
        ...
        <button id="attach-file" type="button" aria-label="Attach file" title="Attach file">
          <LucideIcon size={16}>
            <path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66L8.76 18.07a2 2 0 0 1-2.83-2.83l8.49-8.48" />
          </LucideIcon>
        </button>
        <button id="assistant-chat-button" type="button" aria-label="Open AI assistant" title="Open AI assistant">
          <LucideIcon size={16}>
        ...
        <button id="formula-tracker-button" type="button" aria-label="Open automation list" title="Open automation list">
          <LucideIcon size={16}>
            <path d="M9 6h11" />
            <path d="M9 12h11" />
            <path d="M9 18h11" />
      ...
      <div
        ...
        hidden
      >
        <button id="record-region" type="button" aria-label="Record selected region" title="Record selected region" hidden>
          <LucideIcon size={16}>
            <circle cx="12" cy="12" r="4.5" />
          </LucideIcon>
          <span id="record-region-label">Record</span>
        </button>
        <button id="download-region-recording" type="button" aria-label="Download region GIF" title="Download region GIF" hidden>
          <LucideIcon size={16}>
            <path d="M12 3v12" />
