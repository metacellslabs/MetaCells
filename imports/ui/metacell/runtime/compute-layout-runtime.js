...
export function applyRightOverflowText(app) {
  var options =
    arguments.length > 1 && arguments[1] && typeof arguments[1] === 'object'
      ? arguments[1]
      : {};
  var dirtyRows = Array.isArray(options.rowIndexes) ? options.rowIndexes : null;
  ...
  clearSpillVisualState(app, dirtyRowMap ? { rowIndexes: Object.keys(dirtyRowMap) } : null);
...
export function updateWrappedRowHeights(app) {
  var options =
    arguments.length > 1 && arguments[1] && typeof arguments[1] === 'object'
      ? arguments[1]
      : {};
